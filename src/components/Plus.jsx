...
<section className="text-center lg:text-left lg:pt-20 bg-theme_1"> 
  <div className=" lg:text-center text-justify xl:px-32 ">
    <div className="grid items-center lg:grid-cols-2 ">
      <div className="lg:mb-12">
        <div
          className="relative z-[1] block lg:rounded-lg bg-[hsla(0,0%,100%,0.55)] px-4 pb-4 pt-8 lg:px-6 lg:py-12 dark:bg-theme_2 dark:shadow-black/20 md:px-12 lg:-mr-14 backdrop-blur-[30px] shadow-lg">
          ...
          <div className="grid gap-x-6 md:grid-cols-3 text-center">
            <div className="mb-12 md:mb-0">
              <div ref={ref1} className="text-theme_4 mb-4 text-3xl font-bold">
               {inView1 && <CountUp end={500} duration={2} />}
            +
              </div>
            ...
            <div className="mb-12 md:mb-0">
              <div ref={ref2} className="text-theme_4 mb-4 text-3xl font-bold">
            {inView2 && <CountUp end={200} duration={2} />}
            +
            </div>
              <h5 className="mb-0 text-lg font-medium text-neutral-500 dark:text-neutral-300">
            ...
            <div className="mb-12 md:mb-0">
              <div ref={ref3} className="text-theme_4 mb-4 text-3xl font-bold">
            {inView3 && <CountUp end={1000} duration={2} />}
            MN+
          </div>
              <h5 className="mb-0 text-lg font-medium text-neutral-500 dark:text-neutral-300">
      ...
      <div>
        ...
        <img src={pimg}
          className="hidden lg:block w-[30rem] shadow-lg dark:shadow-black/20" alt="" />
      </div>
    </div>
  </div>
